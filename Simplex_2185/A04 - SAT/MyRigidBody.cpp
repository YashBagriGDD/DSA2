...
uint MyRigidBody::SAT(MyRigidBody* const a_pOther)
{
	...
	*/
	...
	float ra, rb; //ra is the radius of the center of this object to the closest point to the other object
				  //rb is the radius of the center of the other object to the closest point of that object to this
	matrix3 R, AbsR;
	...
	// Use the global centers of the objects
	vector3 t = a_pOther->GetCenterGlobal() - GetCenterGlobal();
	//Multiply the identity matrix by the axis of rotation
	vector3 axes[3];
	axes[0] = vector3(m_m4ToWorld * vector4(1, 0, 0, 0));
	axes[1] = vector3(m_m4ToWorld * vector4(0, 1, 0, 0));
	axes[2] = vector3(m_m4ToWorld * vector4(0, 0, 1, 0));
	// Bring translation into a's coordinate frame
	t = vector3(glm::dot(t, axes[0]), glm::dot(t, axes[1]), glm::dot(t, axes[2]));
